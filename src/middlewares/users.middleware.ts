...
const forgotPasswordTokenSchema: ParamSchema = {
  ...
  custom: {
    options: async (value: string, { req }) => {
      ...
      try {
        const decoced_forgot_password_token = await verifyToken({
          token: value,
          secretOrPublicKey: process.env.JWT_SECRET_FORGOT_PASSWORD_TOKEN as string
        })
        const { user_id } = decoced_forgot_password_token
        ...
        req.decoded_forgot_password_token = decoced_forgot_password_token
      } catch (error) {
...
const imageUrlSchema: ParamSchema = {
  ...
  isLength: {
    ...
    errorMessage: USERS_MESSAGES.IMAGE_URL_LENGTH_MUST_BE_FROM_1_TO_400_CHARACTERS
  }
}
        ...
        custom: {
          options: async (value: string, { req }) => {
            ...
            try {
              ...
              ;(req as Request).decoded_auth = decoded_auth
            } catch (error) {
              throw new ErrorWithStatus({
        ...
        custom: {
          options: async (value: string, { req }) => {
            ...
            try {
              ...
              ;(req as Request).decored_refresh_token = decoded_refresh_token
            } catch (error) {
              if (error instanceof JsonWebTokenError) {
                throw new ErrorWithStatus({
                  message: USERS_MESSAGES.REFRESH_TOKEN_IS_INVALID,
  ...
  checkSchema(
    {
      ...
      location: {
        ...
        isLength: {
          ...
          errorMessage: USERS_MESSAGES.LOCATION_LENGTH_MUST_BE_FROM_1_TO_100_CHARACTERS
        }
      },
      bio: {
        optional: true,
        ...
        isLength: {
          ...
          errorMessage: USERS_MESSAGES.BIO_LENGTH_MUST_BE_FROM_1_TO_200_CHARACTERS
        }
      },
      website: {
        optional: true,
        ...
        isLength: {
          ...
          errorMessage: USERS_MESSAGES.WEBSITE_LENGTH_MUST_BE_FROM_1_TO_200_CHARACTERS
        }
      },
      username: {
        optional: true,
        ...
        isLength: {
          ...
          errorMessage: USERS_MESSAGES.USERNAME_LENGTH_MUST_BE_FROM_1_TO_50_CHARACTERS
        }
      },
